        ...
        try {
            ...
            if (result.success) {
                if (result.audio) {
                    ...
                    // This handles the case where browser speech synthesis is used,
                    // which plays audio directly without returning a data URL.
                    // The onend handler in enhancedTextToSpeech will then call handleAudioEnded.
                    setInterviewState('playing-audio');
                }
            } else {
            ...
            // Directly move to the next state if TTS fails completely
            handleAudioEnded();
        }
    };
